return {
  ...
  opts = {
    ...
    spec = {
      ...
      { "<leader>C", group = "Claude Code", icon = "󰚩" },
      { "<leader>Cc", desc = "Toggle", icon = "󰭹" },
      { "<leader>CC", desc = "Continue last", icon = "↻" },
      { "<leader>Cr", desc = "Resume picker", icon = "󰍉" },
      { "<leader>CV", desc = "Verbose", icon = "" },
